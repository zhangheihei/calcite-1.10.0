...
public class ImmutableBitSet
  ...
  public static ImmutableBitSet range(int fromIndex, int toIndex) {
    ...
    //6 右移也是0 一个long可以表示即可
    int endWordIndex   = wordIndex(toIndex - 1);
    long[] words = new long[endWordIndex + 1];

    //左移fromIndex位(将WORD_MASK上第fromIndex位的bit设置为0,例如fromIndex为0,表示将右边第一位设置为0)
    //1111 1111 1111 1111 1111 1111 1111 1111 1111 1111 1111 1111 1111 1111 1111 1111
    //1111 1111 1111 1111 1111 1111 1111 1111 1111 1111 1111 1111 1111 1111 1111 1111
    long firstWordMask = WORD_MASK << fromIndex;
    //无符号右移-toIndex位，也就是64-toIndex%64位(将WORD_MASK上无符号右移64-toIndex%64位)(64-7)%64=57
    //关注后6位，负数取补码
    //https://bbs.csdn.net/topics/390345111
    //1111 1111 1111 1111 1111 1111 1111 1111 1111 1111 1111 1111 1111 1111 1111 1111
