...
public abstract class Mappings {
  ...
  //createShiftMapping(4, 0, 0, 4)      createShiftMapping(7,4,0,3)
  //0 0
  //1 1
  //2 2
  //3 3
  ...
  public static TargetMapping createShiftMapping(
    ...
    for (int i = 0; i < ints.length; i += 3) {
      final int target = ints[i];       //0 | 100 | 4 | 0 | 0
      final int source = ints[i + 1];   //0 | 0   | 0 | 4 | 0
      final int length = ints[i + 2];   //4 | 3   | 3 | 3 | 4
