 ...
 * plugin mechanism.
 */
//RelMetadataQuery 称之为强类型的原因是， 所有和metadata的相关操作
//都是通过Query进入入口，然后通过Query中的privider 找到具体的
  //操作方法，RelMetadataProvider是弱类型
public class RelMetadataQuery {
  /** Set of active metadata queries, and cache of previous results. */
  //key是List (RelNode, Method) (RelNode, Method, ImmutableBitSet groupKey, RexNode predicate)
