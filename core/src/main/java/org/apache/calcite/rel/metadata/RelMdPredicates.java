...
public class RelMdPredicates
  ...
  public RelOptPredicateList getPredicates(HepRelVertex rel,
      RelMetadataQuery mq) {
    System.out.printf("edwin getPredicates HepRelVertex rel is %s \n",
            rel.toString());
  ...
  public RelOptPredicateList getPredicates(TableScan table,
      RelMetadataQuery mq) {
    System.out.printf("edwin getPredicates TableScan table EMPTY \n");
    return RelOptPredicateList.EMPTY;
  }
  ...
  public RelOptPredicateList getPredicates(Filter filter, RelMetadataQuery mq) {
    ...
    final RelOptPredicateList inputInfo = mq.getPulledUpPredicates(input);
    System.out.printf("edwin getPredicates Filter filter is %s, input is %s, input class is %s \n",
            filter.toString(), input.toString(), input.getClass());
